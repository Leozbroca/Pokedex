...
import { Card, CardImg, Nome, DivImagem, Id, TypesContainer, TypesRow } from "./styled";
    ...
    <Card>
        ...
        <div>
          <Id><p>{id < 100 ? `#0${id}` : `#${id}`}</p></Id>
            ...
            <button onClick={() => adicionarPokedex(pokemon, setPokedex, setOpen, setPokeSnack, setOpenRelease)}>
                Add to Pokedex
            </button>
        </div>}
    </Card>
